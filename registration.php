...
include "includes/db.php"; ?>
    ...
    //     'encrypted' => true
    // );
    // $pusher = new Pusher('ae87c6cb9aa95d1ce30c','7ba218c032517c53d57d','975470',$options);
    ...
    <?php include "includes/nav.php"; ?>
                    ...
                    if($_SERVER['REQUEST_METHOD'] == 'POST'){
                            ...
                            if(username_exists($username)){
                                $error['username'] = "Username exist pick another one";
                            }
                            ...
                            if(email_exists($email)){
                                $error['email'] = " The email exists, <a href = 'index.php' >Please Login</a> ";
                            }
                ...
                <div class="col-xs-6 col-xs-offset-3">
                    ...
                    <h1><?php echo _REGISTER; ?></h1>
                        <form role="form" action="registration.php" method="post" id="login-form" autocomplete="on">
                            <h5 class="text_center"></h5>

                            <div class="form-group">
                    
                                <input value="<?php echo isset($username) ? $username: '' ?>" type="text" name="username" id="username" class="form-control" placeholder="<?php echo _USERNAME; ?>" autocomplete="on">
                                <p><?php echo isset($error['username']) ? $error['username']: '' ?></p>
                            </div>
                            <div class="form-group">
                                <label for="email" class="sr-only">Email</label>
                                <input value = "<?php echo isset($email) ? $email: '' ?>" type="email" name="email" id="email" class="form-control" placeholder="<?php echo _EMAIL; ?>">
